            ...
            <asp:Menu runat="server" DynamicHorizontalOffset="2" Font-Bold="True" 
                ...
                <Items>
                    ...
                    <asp:MenuItem Text="Volunteer" NavigateUrl="Volunteer/Default.aspx">
                        ...
                        <asp:MenuItem Text="Publication" NavigateUrl="Publication/Default.aspx">
                        <asp:MenuItem Text="Add Publication" NavigateUrl="Publication/AddPublication.aspx"></asp:MenuItem>
                        <asp:MenuItem Text="Delete Publication" NavigateUrl="Publication/Default.aspx"></asp:MenuItem>
                        <asp:MenuItem Text="Update Publication" NavigateUrl="Publication/EditPublication.aspx"></asp:MenuItem>
                    </asp:MenuItem>
                    <asp:MenuItem Text="Pharmacy" NavigateUrl="Pharmacy/AddMedicine.aspx">
                    </asp:MenuItem>
                    <asp:MenuItem Text="Image Gallery" NavigateUrl="ImageGalleryAdmin/ImageGalleryAdmin.aspx">
                    </asp:MenuItem>
                    <asp:MenuItem Text="Add Doctor" NavigateUrl="Add Doctor/add.aspx"></asp:MenuItem>
<asp:MenuItem Text="Restaurant" NavigateUrl="~/Admin/Canteen/canteen_admin.aspx"></asp:MenuItem>
                </Items>
